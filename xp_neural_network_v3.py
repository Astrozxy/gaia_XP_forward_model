...
def train(stage=0):
    ...
    if stage<2:
        ...
        ret = train_stellar_model(
            ...
            d_train, d_val,
            weights_per_star,
            idx_train=np.where(idx_hq_large_E),
            optimize_stellar_model=False,
            optimize_stellar_params=True,
            #lr_model_init=1e-7,
            lr_stars_init=1e-5,        
    ...
    if stage<4:
        ...
        # Include more stars by lowering the E limit
        idx_final_train  = np.where(  (d_train['stellar_ext_est']>0.1)
                                                    & idx_good
         )[0]        
